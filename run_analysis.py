"""
Causal TimesFM Engine v3.0: Research Validation Core CLI
=========================================================
Supported Modes:
...
def main():
    parser = argparse.ArgumentParser(description="Causal TimesFM Engine v3.0: Research Validation Core")
    ...
    if args.tournament and args.history_file:
        ...
        print(f"\n[Causal TimesFM Engine v3.0] Running 5-Tier Baseline Tournament on {args.history_file} ({len(data['values'])} points)...")
    ...
    if args.mode == "crypto":
        ...
        print(f"\n[Causal TimesFM Engine v3.0] Analyzing Crypto Asset: {args.ticker}...")
        ...
        print(f"\n[Causal TimesFM Engine v3.0] Analyzing Real Estate: {args.postcode} (£{price:,.2f})...")
        ...
        print("\n[Causal TimesFM Engine v3.0] Analyzing Multi-Asset Portfolio...")
        ...
        print(f"\n[Causal TimesFM Engine v3.0] Analyzing Media Investment & Audience Attention...")
