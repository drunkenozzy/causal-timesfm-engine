"""
CTE R3.1: Research Validation Core CLI
=========================================================
Supported Modes:
...
def main():
    parser = argparse.ArgumentParser(description="CTE R3.1: Research Validation Core")
    ...
    if args.tournament and args.history_file:
        ...
        print(f"\n[CTE R3.1: Research Validation Core] Running 5-Tier Baseline Tournament on {args.history_file} ({len(data['values'])} points)...")
    ...
    if args.mode == "crypto":
        ...
        print(f"\n[CTE R3.1: Research Validation Core] Analyzing Crypto Asset: {args.ticker}...")
        ...
        print(f"\n[CTE R3.1: Research Validation Core] Analyzing Real Estate: {args.postcode} (£{price:,.2f})...")
        ...
        print("\n[CTE R3.1: Research Validation Core] Analyzing Multi-Asset Portfolio...")
        ...
        print(f"\n[CTE R3.1: Research Validation Core] Analyzing Media Investment & Audience Attention...")
